...
namespace App\Models\Traits\Userstamps;
...
trait Userstamps
{
    ...
    {
        static::creating('App\Models\Traits\Userstamps\Listeners\Creating@handle');
        static::updating('App\Models\Traits\Userstamps\Listeners\Updating@handle');

        if (static::usingSoftDeletes()) {
            static::deleting('App\Models\Traits\Userstamps\Listeners\Deleting@handle');
            static::restoring('App\Models\Traits\Userstamps\Listeners\Restoring@handle');
        }
    }
