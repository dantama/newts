...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This configuration value is for caching the passport token based on database,
    | view full documentations at https://github.com/overtrue/laravel-passport-cache-token.
    |
    */
    'cache' => [
        'prefix' => 'passport_',
