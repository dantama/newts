...
@section('content')
    <div class="d-flex align-items-center mb-4">
        <a class="text-decoration-none" href="{{ request('next', route('core::system.roles.index')) }}"><i class="mdi mdi-arrow-left-circle-outline mdi-36px"></i></a>
        <div class="ms-4">
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="card border-0">
                ...
                <div class="card-body border-top">
                    <form class="form-block" action="{{ route('core::system.roles.update', ['role' => $role->id, 'next' => request('next')]) }}" method="POST"> @csrf @method('PUT')
                        ...
                        <div class="mb-0">
                            ...
                            @endcan
                            <a class="btn btn-soft-light text-dark" href="{{ request('next', route('core::system.roles.index')) }}"><i class="mdi mdi-arrow-left"></i> Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="col-sm-8">
            <div class="card border-0">
                ...
                <div class="card-body border-top">
                    <form class="form-block" action="{{ route('core::system.roles.permissions', ['role' => $role->id, 'next' => request('next')]) }}" method="POST"> @csrf @method('PUT')
                        <div class="mb-3">
