...
@php
    ...
    $stats = [
        [
            ...
            'color' => 'warning',
            'count' => \Modules\Event\Models\EventType::count(),
            'desc' => 'Kategori',
        ],
        [
            'icon' => 'mdi mdi-ticket-confirmation-outline',
            'color' => 'danger',
            'count' => \Modules\Event\Models\Event::count(),
            'desc' => 'Kegiatan',
        ],
        [
            'icon' => 'mdi mdi-account-box-multiple-outline',
            'color' => 'primary',
            'count' => \Modules\Event\Models\EventRegistrant::count(),
            'desc' => 'Peserta',
        ],
        [
            'icon' => 'mdi mdi-account-group-outline',
            'color' => 'success',
            'count' => \Modules\Event\Models\Invoice::count(),
            'desc' => 'Invoice',
        ],
    ];
@endphp
