    ...
    <div class="row">
                            ...
                            @forelse($events as $event)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form class="d-inline form-block form-confirm" action="{{ route('event::manage.categories.destroy', ['category' => $event->id]) }}" method="POST"> @csrf @method('DELETE')
        ...
        <div class="col-md-3">
            ...
            <div class="card mb-4 border-0 shadow" id="update-form" style="display: none;">
                ...
                <div class="card-body">
                    <form class="form-block" action="{{ route('event::manage.categories.update', ['category' => $event->id]) }}" method="post"> @csrf @method('PUT')
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="inputEmail4">Nama kategori</label>
                                <div id="idup"></div>
