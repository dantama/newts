...
@section('content')
    <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9">
            ...
            <form class="form-block" action="{{ route('admin::finance.invoices.store', ['next' => $back]) }}" method="POST" enctype="multipart/form-data"> @csrf
                <div class="card border-0">
                    ...
                    <div class="card-body border-top">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-5">
                                <div class="input-group">
                                    <div class="input-group-text border-0">INV</div>
                                    <input type="number" class="form-control @error('code') is-invalid @enderror border-0" name="code" value="{{ old('code', time()) }}" readonly>
                                </div>
                                @error('code')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="datetime-local" class="form-control @error('due_at') is-invalid @enderror" name="due_at" value="{{ old('due_at') }}">
                                @error('due_at')
                                    <small class="text-danger d-block"> {{ $message }} </small>
                                @enderror
                            </div>
...
@push('scripts')
    <template id="item-template">
        <tr>
            <td nowrap class="p-1">
                <input class="d-none" type="hidden" data-name="itemable_type" value="{{ old('itemable_type') }}">
