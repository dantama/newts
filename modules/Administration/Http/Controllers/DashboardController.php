...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        if(auth()->user()->isManagerDistricts()){
            ...
            $warrior_count = Member::whereHas('levels.detail', function($code){ return $code->where('code', 3); })->count();
        
            $cadre_count = Member::whereHas('levels.detail', function($code){ return $code->where('code', 2); })->count();
