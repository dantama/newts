...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h4 class="font-weight-bold mb-0 text-gray-800">Perwil</h4>
</div>
@endsection
...
<div class="row">
    <div class="col-md-9">
                ...
                <table class="table dt-responsive" id="provinceTbl" style="width: 100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $pw->phone }}</td>
                            <td>{{ $pw->email }}</td>
                            <td nowrap><a href="{{ route('administration::managements.perwil.show', ['perwil' => $pw->id]) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a></td>
                        </tr>
                        @empty
                        <tr>
        ...
        <div class="card border-0 shadow mb-4">
            <div class="card-header">Tambah perwil</div>
            <div class="card-body">
                <form class="form-block" action="{{ route('administration::managements.perwil.store', ['next' => request('next', route('administration::managements.perwil.index'))]) }}" method="POST"> @csrf
                    <div class="form-group">
                        <label for="inputAddress">Nama</label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Nama Perwil" required value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div class="form-group">
                        <label for="inputDistric">Negara</label>
    ...
    <div class="col-md-3">
        ...
        <div class="card border-0 shadow mb-4">
            ...
            <div class="list-group list-group-flush">
                <a class="list-group-item list-group-item-action text-danger" href="{{ route('administration::managements.perwil-managers.index', ['pimwil' => request('pimwil')]) }}"><i class="far fa-user"></i> Data pengurus</a>
            </div>
        </div>
    </div>
</div>
