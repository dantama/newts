...
@section('title', 'Edit Pimpinan Daerah')

@section('content')
<div class="row justify-content-center">
	<div class="col-md-8">
		<h4 class="font-weight-bold mb-4">
			<a class="text-decoration-none small" href="{{ route('administration::managements.regencies-managers.index') }}"> <i class="fa fa-arrow-circle-left"></i></a> Pimpinan Daerah
		</h4>
		<div class="card border-0 shadow mb-4">
			<div class="card-body m-3">
				<form class="form-block" action="{{ route('administration::managements.regencies-managers.update', ['manager' => $managers[0]['id']]) }}" method="POST"> @csrf @method('PUT')
					<div class="form-row">
