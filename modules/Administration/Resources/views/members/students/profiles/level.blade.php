	...
	<div class="col-md-8">
		...
		<div class="card border-0 shadow mb-4">
			<div class="card-header">
				<h6>History tingkat <strong>{{ $students[0]['user']['profile']['display_name'] }}</strong></h6>
			</div>	
			<table class="table table-hover mb-0 border-bottom">
				...
				<tbody>
					@foreach($students[0]['levels'] as $member)
					<tr>
	...
	<div class="col-md-4">	
		<div class="card border-0 shadow mb-4">
			<div class="card-body m-3">
				<form class="form-block" action="{{ route('administration::members.students.level-update', ['student' => $students[0]['id']]) }}" method="POST"> @csrf @method('PUT')
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="inputState">Nama</label>
							<input type="text" class="form-control" value="{{ $students[0]['user']['profile']['display_name'] }}" disabled="">
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="inputState">Tingkat</label>
							@foreach($students[0]['levels'] as $mylevel)
								@if($loop->last)
