	...
	<div class="col-md-8">
		...
		<div class="card border-0 shadow mb-4">
			<div class="card-body m-3">
				<form class="form-block" action="{{ route('administration::members.students.profile-update',['student' => $students[0]['user']['id']], ['next' => request('next', route('administration::members.students.index'))]) }}" method="POST"> @csrf @method('PUT')
					<div class="form-group">
						<label for="inputAddress">Full Name</label>
						<input type="text" name="name" class="form-control col-md-12 @error('name') is-invalid @enderror" id="fullname" placeholder="Nama Lengkap" value="{{ $students[0]['user']['profile']['name'] }}" required>
						@error('name')
					...
					<div class="form-group">
						...
						<input type="text" name="nik" class="form-control col-md-12" id="nik" placeholder="NIK" value="{{ $students[0]['user']['profile']['nik'] }}" required>
					</div>
					<div class="form-row">
						...
						<div class="form-group col-md-4">
							...
							<input type="date" class="form-control" id="dob" name="dob" value="{{ $students[0]['user']['profile']['dob'] }}" required>
						</div>
						<div class="form-group col-md-4">
							<label for="inputEmail4">Tempat Lahir</label>
							<input type="text" class="form-control" id="pob" name="pob" value="{{ $students[0]['user']['profile']['pob'] }}" required>
						</div>
					</div>
					<div class="form-group">
						<label for="inputAddress">Gelar Depan</label>
						<input type="text" name="prefix" class="form-control col-md-12" value="{{ $students[0]['user']['profile']['prefix'] }}" id="prefix">
					</div>
					<div class="form-group">
						<label for="inputAddress">Gelar Belakang</label>
						<input type="text" name="suffix" class="form-control col-md-12" value="{{ $students[0]['user']['profile']['suffix'] }}" id="suffix">
					</div>
					<div class="form-group">
