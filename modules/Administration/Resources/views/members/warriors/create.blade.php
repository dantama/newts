...
<div class="row justify-content-center">
	<div class="col-md-8">
		<h4 class="font-weight-bold mb-4">
			<a class="text-decoration-none small" href="{{ route('administration::members.warriors.index') }}"> <i class="fa fa-arrow-circle-left"></i></a> Tambah Pendekar
		</h4>
		<div class="card border-0 shadow mb-4">
			<div class="card-body m-3">
				<form class="form-block" action="{{ route('administration::members.warriors.store', ['next' => request('next', route('administration::members.warriors.index'))]) }}" method="POST"> @csrf
