...
<div class="row justify-content-center">
	<div class="col-md-8">
		<h4 class="font-weight-bold mb-4">
			<a class="text-decoration-none small" href="{{ route('administration::members.account.show',['account' => $members[0]['id']]) }}"> <i class="fa fa-arrow-circle-left"></i></a> Profil Anggota
		</h4>
	...
	$(document).ready(function(){
		...
		$('.crop_image').click(function(event){
			$image_crop.croppie('result', {
				...
				$.ajax({
					url:'{{ route("administration::members.account.avatar-update") }}',
					type:'post',
