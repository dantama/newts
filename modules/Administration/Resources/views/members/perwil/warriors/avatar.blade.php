...
<div class="row justify-content-center">
	<div class="col-md-8">
		<h4 class="font-weight-bold mb-4">
			<a class="text-decoration-none small" href="{{ route('administration::members.perwil-warriors.show',['perwil_warrior' => $members['id']]) }}"> <i class="fa fa-arrow-circle-left"></i></a> Profil Pendekar
		</h4>
	...
	$(document).ready(function(){
		...
		$('.crop_image').click(function(event){
			$image_crop.croppie('result', {
				...
				var user_id = {{ $members['user']['id'] }}
				$.ajax({
					url:'{{ route("administration::members.perwil-warriors.avatar-update") }}',
					type:'post',
