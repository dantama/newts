...
@section('title', 'Edit Tingkat Pendekar')
	...
	<div class="col-md-8">
		...
		<div class="card border-0 shadow mb-4">
			<div class="card-header">
				<h6><i class="fa fa-list"></i> History <strong>{{ $members['user']['profile']['display_name'] }}</strong></h6>
			</div>	
			<table class="table table-hover mb-0 border-bottom">
				...
				<tbody>
					@foreach($members['levels'] as $member)
					<tr>
	...
	<div class="col-md-4">
		<div class="card border-0 shadow mb-2">
			<div class="card-body m-3">
				<form class="form-block" action="{{ route('administration::members.perwil-warriors.level-update', ['perwil_warrior' => $members['id']]) }}" method="POST"> @csrf @method('PUT')
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="inputState">Name</label>
							<input type="text" class="form-control" value="{{ $members['user']['profile']['display_name'] }}" disabled="">
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="inputState">Level</label>
							@foreach($members['levels'] as $mylevel)
								@if($loop->last)
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="inputState">New level</label>
					...
					<button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-paper-plane"></i> Update level</button>
				</form>
			</div>
		</div>
	</div>
