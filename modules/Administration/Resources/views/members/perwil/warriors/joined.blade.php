...
@section('title', 'Edit Tahun Bergabung')

@section('content')
<div class="row justify-content-center">
	<div class="col-md-8">
		<h4 class="font-weight-bold mb-4">
			<a class="text-decoration-none small" href="{{ route('administration::members.warriors.show',['warrior' => $members->id]) }}"> <i class="fa fa-arrow-circle-left"></i></a> Profil Pendekar
		</h4>
		<div class="card border-0 shadow mb-4">
			<div class="card-body m-3">
				<form class="form-block" action="{{ route('administration::members.warriors.joined-update',['warrior' => $members->id], ['next' => request('next', route('administration::members.warriors.index'))]) }}" method="POST"> @csrf @method('PUT')
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="inputState">Tahun Bergabung</label>
