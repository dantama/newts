...
<body>
	...
	<div>
		<img src="{{ asset('img/depan.jpg') }}" style="position: absolute; z-index: -1; width: 3.37in, height: 2.2in;">
		<img src="{{ $member->user->profile->avatar_path }}" style="position: absolute; right: .3cm; bottom: -1.25in; height: 65px; width: 50px; border: 1.5px solid #fff; border-radius: 30%;">
		<img src="{{ Storage::url($member->qr) }}" style="position: absolute; left: 1.05cm; bottom: -1.05in; z-index: 9999; height: 1.1cm; width: 1.1cm; border: 2px solid #fff;">
		<div style="margin: 3.1cm .1cm -1cm .4cm">
			<table width="100%" style="line-height: .4em margin-left: .3cm" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="2" class="alnright" style="color: white; padding-left: .1cm; padding-top: .2cm;">
						<p class="f12" style="margin: 3px -18px 0 0; letter-spacing: 5px;"><strong>{{ str_replace('-', ' ', $member->nbts) }}</strong></p>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td width="25%" class="alnleft" style="color: white; padding-left: .1cm;">
						<p class="f7" style="margin-left: .5cm;">Created</p>
						<p class="f10" style="margin-left: .5cm; margin-top: 3px;"><b>{{ date('m/y') }}</b></p>
					</td>
	...
	<div>
		<img src="{{ asset('img/belakang2.png') }}" style="position: absolute; z-index: -1; width: 3.37in, height: 2.11in;">
		<div style="margin: .8cm;">
