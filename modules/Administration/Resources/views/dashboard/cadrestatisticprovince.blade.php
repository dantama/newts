	...
	<div class="col-md-3">
		<div class="card border-left-danger border-0 shadow">
			...
			<div class="list-group list-group-flush">
				<a class="list-group-item list-group-item-action text-danger content-block" href="{{ route('administration::cadre-statistic') }}"><i class="fa fa-plus-circle"></i> Tampilkan per daerah</a>
			</div>			
		</div>
	</div>
</div>
