...
@section('navtitle', 'Tambah departemen')
        ...
        <div class="col-xxl-8 col-xl-10">
            ...
            <div class="card mb-4 border-0">
                <div class="card-body border-bottom">
                    <i class="mdi mdi-plus"></i> Form tambah departemen
                </div>
                <div class="card-body">
                    <form class="form-block" action="{{ route('core::administration.units.store', ['unit' => $currentUnit->kd, 'next' => request('next')]) }}" method="POST"> @csrf
                        <div class="row mb-3">
                            <label class="col-lg-4 col-xl-4 col-form-label">Departemen</label>
                        ...
                        <div class="row mb-3">
                            <label class="col-lg-4 col-xl-4 col-form-label">Pimpinan departemen</label>
                            <div class="col-lg-8 col-xl-8">
