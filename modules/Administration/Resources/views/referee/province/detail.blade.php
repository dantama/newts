...
<div class="row">
	...
	<div class="col-md-4">
		<div class="card">
			...
			<div class="card-body">
				<form class="form-block" method="POST" enctype="multipart/form-data" action="{{ route('administration::technical.province-referees.store-level', ['referee' => $referees[0]['id']]) }}">@csrf
