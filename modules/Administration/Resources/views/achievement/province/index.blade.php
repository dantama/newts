...
@section('title', 'Daftar Prestasi Wilayah')
...
<div class="row">
    <div class="col-md-8"> 
        <div class="card border-0 shadow mb-4">
            <div class="card-header">Daftar Prestasi Wilayah</div>
            @if(request('trash'))
            ...
            @endif
            <div class="card-body">
                <form class="form-block" action="{{ route('administration::achievement.province-achievements.index') }}" method="GET">
                ...
                <table class="table table-hover mb-0 border-bottom" id="kader">
                    ...
                    <tbody>
                        @forelse($UserAchievementProvince as $achievement)
                        <tr @if($achievement->trashed()) class="text-muted bg-light" @endif>
                            ...
                            <td>
                                ...
                                @else
                                    <a href="{{ route('administration::achievement.province-achievements.show', ['achievement' => $achievement->id]) }}">{{ $achievement['user']['profile']['display_name'] }}</a>
                                @endif
                            </td>                     
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow mb-4">
            ...
            <div class="card-body">
                <span class="h1 mb-0 font-weight-bold">{{ $UserAchievementProvince_count }}</span>
                <span class="float-right text-muted font-weight-bold"><i class="far fa-user"></i> Prestasi Wilayah</span>
            </div>
        </div>
        <div class="card border-0 shadow mb-4">
            <div class="card-header">Tambah Prestasi</div>
            <div class="card-body">
                <form method="POST" action="{{ route('administration::achievement.province-achievements.store', ['next' => request('next',route('administration::achievement.center-achievements.index'))]) }}">@csrf
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select name="type_id" id="type_id" class="form-control selectpicker" data-live-search="true" required="">
                        <option value="">Pilih</option>
