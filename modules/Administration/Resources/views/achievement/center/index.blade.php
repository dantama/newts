...
<div class="row">
        ...
        <div class="card border-0 shadow mb-4">
            ...
            <div class="card-body">
                <table class="table table-hover mb-0 border-bottom" id="kader">
                    ...
                    <tbody>
                        @forelse($UserAchievementCentral as $achievement)
                        <tr @if($achievement->trashed()) class="text-muted bg-light" @endif>
                            ...
                            <td>
                                ...
                                @else
                                    <a href="{{ route('administration::achievement.center-achievements.show', ['achievement' => $achievement->id]) }}">{{ $achievement['user']['profile']['display_name'] }}</a>
                                @endif
                            </td>                     
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow mb-4">
            ...
            <div class="card-body">
                <span class="h1 mb-0 font-weight-bold">{{ $UserAchievementCentral_count }}</span>
        ...
        <div class="card border-0 shadow mb-4">
            ...
            <div class="card-body">
                <form class="form-block" method="POST" action="{{ route('administration::achievement.center-achievements.store',['next' => request('next',route('administration::achievement.center-achievements.index'))]) }}">@csrf
